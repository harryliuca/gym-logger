...
-- Total rows: 61
-- Generated: 2025-10-12T07:35:13.332Z
...
BEGIN
  ...
  -- Session: 2025-06-05 (Legs, Push)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-05', '', 0, 'Legs, Push')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-09 (Legs, Push)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-09', '', 0, 'Legs, Push')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-10 (Push, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-10', '', 0, 'Push, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-15 (Legs, Pull, Push)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-15', '', 0, 'Legs, Pull, Push')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-16 (Legs, Push, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-16', '', 0, 'Legs, Push, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-17 (Legs, Push, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-17', '', 0, 'Legs, Push, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-18 (Push, Legs)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-18', '', 0, 'Push, Legs')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-23 (Legs, Pull, Push)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-23', '', 0, 'Legs, Pull, Push')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-24 (Legs, Push, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-24', '', 0, 'Legs, Push, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-06-25 (Push, Legs)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-06-25', '', 0, 'Push, Legs')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-07-14 (Legs, Pull, Push)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-07-14', '', 0, 'Legs, Pull, Push')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-07-15 (Legs, Push, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-07-15', '', 0, 'Legs, Push, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-07-16 (Push, Legs)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-07-16', '', 0, 'Push, Legs')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-07-21 (Legs, Pull, Push)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-07-21', '', 0, 'Legs, Pull, Push')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-07-22 (Legs, Push, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-07-22', '', 0, 'Legs, Push, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-07-23 (Push, Legs)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-07-23', '', 0, 'Push, Legs')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-08-26 (Legs, Pull, Push)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-08-26', '', 0, 'Legs, Pull, Push')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-08-27 (Legs, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-08-27', '', 0, 'Legs, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-09-02 (Legs, Pull, Push, Pull)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-09-02', '', 0, 'Legs, Pull, Push, Pull')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
  ...
  -- Session: 2025-09-03 (Push, Pull, Legs)
  INSERT INTO public.workout_sessions (user_id, session_date, notes, total_volume, category)
  VALUES (v_user_id, '2025-09-03', '', 0, 'Push, Pull, Legs')
  ON CONFLICT (user_id, session_date) DO NOTHING
  RETURNING id INTO v_session_id;
